...
build {
  ...
  provisioner "windows-restart" {
    pause_before          = "1m0s"
    restart_check_command = "powershell -command \"& {Write-Output 'after phase 2 - restarted.'}\""
    restart_timeout       = "2h"
  }
    ...
    elevated_password = "password"
    elevated_user     = "Administrator"
    script            = "./extra/scripts/windows/shared/phase-4.windows-updates.ps1"
  }

  provisioner "windows-restart" {
    pause_before          = "1m0s"
    restart_check_command = "powershell -command \"& {Write-Output 'after phase 4.windows-updates - restarted.'}\""
    restart_timeout       = "2h"
  }
  ...
  provisioner "windows-restart" {
    pause_before          = "1m0s"
    restart_check_command = "powershell -command \"& {Write-Output 'after phase 5a.software - restarted.'}\""
    restart_timeout       = "2h"
  }
  ...
  provisioner "powershell" {
    elevated_password = "password"
    elevated_user     = "Administrator"
    script            = "./extra/scripts/windows/shared/phase-5b.software.ps1"
  }

  provisioner "windows-restart" {
    pause_before          = "1m0s"
    restart_check_command = "powershell -command \"& {Write-Output 'after phase 5b.software - restarted.'}\""
    restart_timeout       = "2h"
  }
